...
pub use wal::{
    ...
    promote_stale_in_flight_to_recovery_required, register_retryable_error, AcceptWalPayload,
    AcceptWalPreparedAccept, AcceptWalTransfer, SettlementWalPayload, WalEntry, WalExecutionError,
    WalExecutionOutcome, WalKind, WalPayload, WalPolicy, WalResult, WalRetryDrain, WalStatus,
