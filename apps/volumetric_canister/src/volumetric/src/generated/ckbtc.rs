...
#[derive(CandidType, Deserialize)]
pub enum MinterArg { Upgrade(Option<UpgradeArgs>), Init(InitArgs) }
#[derive(CandidType, Deserialize)]
...
#[derive(CandidType, Deserialize)]
pub struct EnvironmentVariable { pub value: String, pub name: String }
#[derive(CandidType, Deserialize)]
...
#[derive(CandidType, Deserialize)]
pub struct GetEventsArg { pub start: u64, pub length: u64 }
...
#[derive(CandidType, Deserialize)]
pub struct UtxoOutpoint { pub txid: serde_bytes::ByteBuf, pub vout: u32 }
#[derive(CandidType, Deserialize)]
pub struct Utxo { pub height: u32, pub value: u64, pub outpoint: UtxoOutpoint }
#[derive(CandidType, Deserialize)]
...
#[derive(CandidType, Deserialize)]
pub struct WithdrawalFee { pub minter_fee: u64, pub bitcoin_fee: u64 }
#[derive(CandidType, Deserialize)]
...
pub enum InvalidTransactionError {
  ...
  TooManyInputs{ max_num_inputs: u64, num_inputs: u64 },
}
#[derive(CandidType, Deserialize)]
...
pub enum ReplacedReason {
  ...
  ToCancel{ reason: WithdrawalReimbursementReason },
...
pub enum EventType {
  ...
  DistributedKytFee{ block_index: u64, amount: u64, kyt_provider: Principal },
  #[serde(rename="init")]
  Init(InitArgs),
  ...
  SuspendedUtxo{ utxo: Utxo, account: Account, reason: SuspendedReason },
  ...
  ReimbursedWithdrawal{ burn_block_index: u64, mint_block_index: u64 },
}
#[derive(CandidType, Deserialize)]
pub struct Event { pub timestamp: Option<u64>, pub payload: EventType }
#[derive(CandidType, Deserialize)]
...
#[derive(CandidType, Deserialize)]
pub struct RetrieveBtcStatusArg { pub block_index: u64 }
#[derive(CandidType, Deserialize)]
...
#[derive(CandidType, Deserialize)]
pub struct RetrieveBtcStatusV2Arg { pub block_index: u64 }
#[derive(CandidType, Deserialize)]
...
#[derive(CandidType, Deserialize)]
pub struct PendingUtxoOutpoint { pub txid: serde_bytes::ByteBuf, pub vout: u32 }
...
impl Service {
  ...
  pub async fn estimate_withdrawal_fee(&self, arg0: &EstimateWithdrawalFeeArg) -> Result<(EstimateWithdrawalFeeRet,)> {
  ...
  pub async fn retrieve_btc(&self, arg0: &RetrieveBtcArgs) -> Result<(std::result::Result<RetrieveBtcOk, RetrieveBtcError>,)> {
  ...
  pub async fn retrieve_btc_status(&self, arg0: &RetrieveBtcStatusArg) -> Result<(RetrieveBtcStatus,)> {
  ...
  pub async fn retrieve_btc_status_v2(&self, arg0: &RetrieveBtcStatusV2Arg) -> Result<(RetrieveBtcStatusV2,)> {
  ...
  /// 
  pub async fn retrieve_btc_status_v2_by_account(&self, arg0: &Option<Account>) -> Result<(Vec<RetrieveBtcStatusV2ByAccountRetItem>,)> {
  ...
  pub async fn retrieve_btc_with_approval(&self, arg0: &RetrieveBtcWithApprovalArgs) -> Result<(std::result::Result<RetrieveBtcOk, RetrieveBtcWithApprovalError>,)> {
  ...
  pub async fn update_balance(&self, arg0: &UpdateBalanceArg) -> Result<(std::result::Result<Vec<UtxoStatus>, UpdateBalanceError>,)> {
