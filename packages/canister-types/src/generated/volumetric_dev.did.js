export const idlFactory = ({ IDL }) => {
  ...
  const XrcSettlementTimeProbe = IDL.Record({
    'xrc_request_timestamp_seconds' : IDL.Nat64,
    'settlement_time_seconds' : IDL.Nat64,
  ...
  const Result_9 = IDL.Variant({ 'Ok' : Result_7, 'Err' : VolumetricError });
  ...
  const Result_11 = IDL.Variant({ 'Ok' : IDL.Text, 'Err' : VolumetricError });
  ...
  const Result_15 = IDL.Variant({ 'Ok' : IDL.Nat, 'Err' : VolumetricError });
  ...
  const Result_28 = IDL.Variant({
    'Ok' : IDL.Opt(StoredXrcBtcUsdRate),
    'Err' : VolumetricError,
  });
  const Result_29 = IDL.Variant({
    'Ok' : IDL.Vec(StoredXrcBtcUsdRate),
    'Err' : VolumetricError,
  });
  ...
  return IDL.Service({
    ...
    'fetch_and_store_xrc_btc_usd_exchange_rate_snapshot' : IDL.Func(
        [],
        [Result_6],
        [],
      ),
    'fetch_xrc_btc_usd_exchange_rate_for_settlement_time' : IDL.Func(
        [IDL.Nat64],
        [Result_8],
        [],
      ),
    'fetch_xrc_btc_usd_exchange_rate_snapshot' : IDL.Func([], [Result_9], []),
    'get_accept_by_id' : IDL.Func([IDL.Nat64], [Result_10], ['query']),
    'get_accept_offers_message' : IDL.Func(
        [IDL.Text, IDL.Vec(AcceptOfferItem), IDL.Nat64],
        [Result_11],
        ['query'],
      ),
    'get_accept_status' : IDL.Func([IDL.Vec(IDL.Nat8)], [Result_12], ['query']),
    'get_account_info' : IDL.Func([IDL.Text, IDL.Bool], [Result_13], ['query']),
    ...
    'get_ckbtc_balance' : IDL.Func([IDL.Text], [Result_15], []),
    ...
    'get_deposit_address' : IDL.Func([IDL.Text], [Result_16], []),
    ...
    'get_failed_accepts' : IDL.Func([], [Result_17], ['query']),
    'get_failed_settlements' : IDL.Func([], [Result_18], ['query']),
    'get_failed_withdrawals' : IDL.Func([], [Result_19], ['query']),
    ...
    'get_my_offers' : IDL.Func([IDL.Text], [Result_20], ['query']),
    'get_my_options' : IDL.Func([IDL.Text], [Result_21], ['query']),
    ...
    'get_my_written_options' : IDL.Func([IDL.Text], [Result_21], ['query']),
    'get_offer_by_id' : IDL.Func([IDL.Nat64], [IDL.Opt(Offer)], ['query']),
    'get_open_offers' : IDL.Func([], [IDL.Vec(Offer)], ['query']),
    'get_pending_accepts' : IDL.Func([], [Result_17], ['query']),
    'get_pending_settlements' : IDL.Func([], [Result_21], ['query']),
    'get_pending_settlements_journal' : IDL.Func([], [Result_18], ['query']),
    'get_pending_withdrawals' : IDL.Func([], [Result_19], ['query']),
    ...
    'get_settlement_by_id' : IDL.Func([IDL.Nat64], [Result_23], ['query']),
    ...
    'get_user_balance' : IDL.Func([IDL.Text], [Result_25], ['query']),
    ...
    'get_withdrawal_by_id' : IDL.Func([IDL.Nat64], [Result_27], ['query']),
    'get_xrc_btc_usd_rate_by_timestamp' : IDL.Func(
        [IDL.Nat64],
        [Result_28],
        ['query'],
      ),
    'list_cached_xrc_btc_usd_rates' : IDL.Func(
        [IDL.Opt(IDL.Nat32)],
        [Result_29],
        ['query'],
      ),
    'list_users' : IDL.Func([], [Result_30], ['query']),
    'list_whitelisted' : IDL.Func([], [Result_31], ['query']),
    'observability_get_metrics' : IDL.Func([], [Result_32], ['query']),
    'prune_old_xrc_btc_usd_rates' : IDL.Func([], [Result_3], []),
    'prune_xrc_btc_usd_rates_before' : IDL.Func([IDL.Nat64], [Result_3], []),
    'recover_wal_operation' : IDL.Func([IDL.Vec(IDL.Nat8)], [Result_33], []),
    ...
    'settle_expired_options' : IDL.Func([], [Result_34], []),
    'settle_option_by_id' : IDL.Func([IDL.Nat64], [Result_35], []),
    'update_ckbtc_balance' : IDL.Func([IDL.Text], [Result_36], []),
    ...
    'withdraw_ckbtc' : IDL.Func([AuthenticatedPayload_6], [Result_37], []),
  });
};
