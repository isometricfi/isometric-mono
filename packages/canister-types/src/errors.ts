import type { ProfileInfo, Result_11, VolumetricError } from "./generated/volumetric_dev.did";
...
export function profileFromGetAccountInfoResult(result: Result_11): ProfileInfo | null {
